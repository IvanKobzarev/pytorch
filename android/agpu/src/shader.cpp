#include "shader.h"
const char* convolution_buffers_out_nc4hw_glsl = 
...
"}\n"
;
const char* convolution_buffers_inout_nchw_2_glsl = 
"layout(std430) buffer;\n"
"layout(binding=0) writeonly buffer outBuffer{\n"
"  float data[];\n"
"}uOutputBuffer;\n"
...
"}\n"
;
const char* convolution_buffers_inout_nhwc_glsl = 
"layout(std430) buffer;\n"
"layout(binding=0) writeonly buffer outBuffer{\n"
"  float data[];\n"
"}uOutputBuffer;\n"
...
"}\n"
;
const char* convolution_buffers_inout_nchw_glsl = 
"layout(std430) buffer;\n"
"layout(binding=0) writeonly buffer outBuffer{\n"
"  float data[];\n"
"}uOutputBuffer;\n"
...
"}\n"
;
const char* convolution_buffers_inout_nchw_1_glsl = 
"layout(std430) buffer;\n"
"layout(binding=0) writeonly buffer outBuffer{\n"
"  float data[];\n"
"}uOutputBuffer;\n"
...
"}\n"
;
const char* convolution_buffers_out_nchw_glsl = 
"layout(std430) buffer;\n"
"layout(binding=0) writeonly buffer outBuffer{\n"
"  float data[];\n"
"}uOutputBuffer;\n"
...
"}\n"
;
const char* convolution_buffers_out_nc4hw_1_glsl = 
"layout(std430) buffer;\n"
"layout(binding=0) writeonly buffer outBuffer{\n"
"  vec4 data[];\n"
"}uOutputBuffer;\n"
